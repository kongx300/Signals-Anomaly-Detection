...
% 
    ...
    % Plot the spectrum of the fft of the sample 
    figure(1)
    plot(t,v_sample);
    hold on;
    plot(t,v_sample,'ro');
    title("The sample sine wave")
    ...
    Ur = U(:,r);
    % Create projection
    Nr = diag(ones(size(Ur))) - Ur*((Ur'*Ur)\Ur');
    ...
    % v_sample2 = sin(2*pi*f1*t);
    % noise = normrnd(0,1,size(t));
    % v_sample2 = v_sample2 + noise;
    f1 = 3;%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    v_sample2 = sin(2*pi*f1*t);
